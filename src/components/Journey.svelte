...
<section
    id="journey"
    class="section-spacing bg-[var(--color-primary)] text-white relative overflow-hidden"
>
    <!-- Background Pattern -->
    ...
    <div class="container relative z-10">
        ...
        <div class="relative">
            ...
            >
                ...
                <div
                    class="absolute top-1/2 left-0 right-0 h-1 bg-[var(--color-primary-light)]/30 -translate-y-1/2 rounded-full min-w-full"
                ></div>
                ...
                <div class="flex gap-8 min-w-max px-4">
                    {#each timelineData as item, index}
                        ...
                        >
                            <div
                                class="absolute top-10 right-10 w-4 h-4 bg-white rounded-full -translate-x-1/2 -translate-y-1/2 z-10 shadow-[0_0_0_8px_rgba(33,150,243,0.5)] group-hover:scale-125 transition-transform duration-300"
                            />
                            <div
